...
/**
 * Load a set of Render Controller mappings from a seekable SDL data stream.
 *
...
/**
 * Get the current mapping of a Render Controller.
 *
 * The returned string must be freed with SDL_free().
 *
...
/**
 * Get the Joystick ID from a Render Controller.
 *
...
/**
 * Query or change current state of Render Controller events.
 *
